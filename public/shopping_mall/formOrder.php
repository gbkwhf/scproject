...
<body>
	...
	<div class="wrapper">
		<header>
			<div class="user-name" >收货人：<p></p></div>
			<div class="user-phone" ><p></p></div>
		...
		<div class="js-details">
			<div class="commodityBox">
				<div class="shopNames">
					...
					<div class="shop_name">黄豆豆花卉店</div>
				</div>
		...
		<div class="express">
			<div class="expressWord">配送方式:</div>
			<div class="selectBox">快递发货</div>
		</div>
		<div class="note">
			<p>备注：</p><input type="text" placeholder="给商家留言（选填）" />
		</div>
		<div class="express">
			<div class="expressWord">优惠券:</div>
			<div class="selectBox">使用优惠券</div>
		</div>
		<div class="amountBox">
