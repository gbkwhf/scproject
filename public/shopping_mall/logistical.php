...
<html>
	...
	<body>
		...
		<div class="logistBot">
			...
			<li class="liBox">
				...
				<div class="liBoxRight">
					<div class="logCon">期待菜鸟一哈哈哈哈哈哈哈哈哈哈期待菜鸟一哈哈哈哈哈哈哈哈</div>
					<div class="logCon1"><span>2017-10-24  10.36.36</span></div>
				</div>
			</li>
			<li class="liBox">
	...
	<script type="text/javascript">
		$(function() {
			...
			//			{
			//				'context':'我是内容1',
			//				'time':'2017-12-34 10:30:21'
			//				
			//			},
			//			{
			//				'context':'我是内容22222222222',
			//				'time':'2017-12-34 10:30:21'
			//				
			//			},
			//			{
			//				'context':'我是内容33333333333333',
			//				'time':'2017-12-34 10:30:21'
			//				
			//			}
			//		]
//			$('#orderNumber').html($_GET['sub_order_id']);
...
//								var express_name = con[k].express_name; //快递名称
//								var express_num = con[k].express_num; //快递单号
...
//					"</div>" +
//					"<div class='liBoxRight'>" +
//					"<div class='logCon'>" + arr[k].context + "</div>" +
//					"<div class='logCon1'><span>" + arr[k].time + "</span></div>" +
//					"</div>" +
//					"</li>";
//			});
//
//			$('#lofinContext').html(html);
//			//这是有绿色的按钮和线条
//			var val = "<div class='liTopWap'><div class='liTopWap1'><div class='liTopWap3'></div></div></div><div class='liLine'></div>";
//			//这是最后那一个没有线条
//			var lastVal = "<div class='liTopWap3 liTopWap4'></div>";
