...
<body>
	...
	<div class="wrapper">
		...
		<div class="explain-buy">
			...
			<ul class="xz-list">
				<li>
					<em>1.</em>会员必须在平台消费1280元/单（含1280）以上，且订单完成（无退货）。
					<p>利润共享标准：每日平台总利润50%÷会员每日订单基数；利润共享天数：180天，由系统每天自动返还。</p>
				</li>
				<li><em>2.</em>如果一单不能满足利润共享基数，可以凑单并合并结算，总金额达到基数要求，方可享受利润共享。</li>
			</ul>
		</div>
		<footer>
