		...
		<div class="container">
			<div id="illness">
				...
				<div class="border-box">
					...
					<input type="text" placeholder="请填写病情诊断" name="diagnosis" id="diagnosis" />
				</div>
				<div class="border-box">
...
//                          console.log(data);
                            if(data.code==1){                           	
                                ...
                                $(filetest).remove();
                                html='';
                                html+='<div class="upload" org_img="" imgid="" >';
...
//					endYear: currYear + 10 //结束年份
				...
				$("#build_time").val('').scroller('destroy').scroller($.extend(opt['date'], opt['default']));
