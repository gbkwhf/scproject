...
class AgencyManageController  extends Controller
{
 ...
 public  function MemberCashList (Request $request){
 	...
 	->selectRaw('ys_member.name,ys_member.mobile,ys_operate_bills.amount,ys_operate_bills.created_at,ys_operate_bills.finished_at,ys_operate_bills.state,ys_operate_bills.employee_id');
 	$search=[];
 	if ($request->start != ''){
