...
@section('main-content')
    ...
    <div class="box box-info">
        <!-- /.box-header -->
        <!-- form start -->
        @section('contentheader_title','添加商品二级分类')

        <form class="form-horizontal" action="{{url('commody/class/manage/second/add/save')}}" method="post"  enctype ="multipart/form-data">
