...
@section('main-content')
    ...
    <div class="box box-info">
        <!-- /.box-header -->
        <!-- form start -->
        @section('contentheader_title','编辑Banner图')

        <form class="form-horizontal" action="{{url('banner/edit/save')}}" method="post"  enctype ="multipart/form-data">


                    <input name="edit_id" type="hidden"   value="{{$data->id}}" />
