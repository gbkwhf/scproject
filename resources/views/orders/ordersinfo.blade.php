        ...
        <form class="form-horizontal" action="{{url('order/ordersave')}}" method="post"  enctype ="multipart/form-data">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea  style="height:150px" class="form-control" disabled="true " name="service_content" placeholder="Enter ..." >{{ $data['service_content']}}</textarea>
                    </div>
                </div>
                @endif
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" disabled="true " name="manage_id" placeholder="Enter ..." value="{{ $data['manage_id']}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" disabled="true " name="manage_time" placeholder="Enter ..." value="{{ $data['manage_time']}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" >反馈内容</label>
                    <div class="col-sm-10">
                        <textarea  style="height:150px" class="form-control" disabled="true " name="manage_content" placeholder="Enter ..." >{{ $data['manage_content']}}</textarea>
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
