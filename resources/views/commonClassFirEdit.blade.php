...
@section('main-content')
    ...
    <div class="box box-info">
        <!-- /.box-header -->
        <!-- form start -->
        @section('contentheader_title','编辑商品一级分类')

        <form class="form-horizontal" action="{{url('commody/class/manage/first/edit/save')}}" method="post"  enctype ="multipart/form-data">
