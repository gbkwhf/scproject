...
@section('main-content')
    ...
    <div class="box box-info">
        <!-- /.box-header -->
        <!-- form start -->
        @section('contentheader_title','编辑门店分类')

        <form class="form-horizontal" action="{{url('supplieredit/shop/class/edit/save')}}" method="post"  enctype ="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  name="shopClassName"  placeholder="Enter ..." class="form-control" value="{{$data->name}}">
                        </div>
                    </div>
                    <div class="form-group">
