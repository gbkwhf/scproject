          ...
          <div class="box">
               ...
               <br><br>
                  <div class="box-tools2 ">
                      <form class="form-horizontal" id ="form_action" action="{{url('agency/memberlist')}}" method="get">
              ...
              <table class="table table-hover">
                ...
                @foreach ($data as $member)    				
	    			<tr>
	                  ...
	                  <td>{{ $member->state }}</td>	
	                  <td>
	                  		<a href="{{ url('agency/memberedit',['id'=>$member->user_id]) }}"><button class="btn bg-orange margin" type="button">编辑</button></a>
	                  </td>
	                </tr>                
				@endforeach               
              </tbody></table>
