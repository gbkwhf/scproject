          ...
          <div class="box">
               ...
               <br><br>
                  <div class="box-tools2 ">
                      <form class="form-horizontal" id ="form_action" action="{{url('manage/applytoweixin')}}" method="get">
                ...
                @foreach ($data as $bill)    				
	    			<tr>
                      ...
                      <td>{{ $bill->created_at }}</td>
                        <td>{{ $bill->state }}</td>
	                  <td>
	                  		<a href="{{ url('manage/applytoweixindetial',['id'=>$bill->id]) }}"><button class="btn bg-orange margin" type="button">详情</button></a>
	                  </td>
	                </tr>                
				@endforeach               
              </tbody></table>
