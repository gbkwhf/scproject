...
@section('main-content')
    ...
    <div class="box box-info">
        <!-- /.box-header -->
        <!-- form start -->
        @section('contentheader_title','编辑商品规格')

        <form class="form-horizontal" action="{{url('spec/edit/save')}}" method="post"  enctype ="multipart/form-data">


                    <div class="form-group">
                        <label class="col-sm-2 control-label" >规格名称</label>
                        <div class="col-sm-10">
                            <input type="text"  name="spec"  placeholder="Enter ..." class="form-control" value="@if(!empty( $data->name))  {{$data->name}} @endif">
                        </div>
                    </div>
