...
<div class="box box-info">
            ...
            <!-- form start -->
             @if (isset($data) )
             	...
             	<form class="form-horizontal" action="{{ url('manage/depositordersave') }}" method="post"  enctype ="multipart/form-data">
             @endif
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                      <label class="col-sm-2 control-label" >确认开通</label>
                      <div class="col-sm-10">
                          <select class="form-control" name="confirm_state">
                              <option @if (isset($data) &&  $data->confirm_state == 1) selected="" @endif value="1" >开通权限</option>
