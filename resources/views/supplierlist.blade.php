          ...
          <div class="box">
              <div class="box-header">{{----}}                  
                  <div class="box-tools2 ">
                      <form class="form-horizontal" action="{{url('supplierlist')}}" method="get">
                          <div style="width: 800px;" class="input-group input-group-sm row">
                              ...
                              <div class="col-lg-3">
                                  <input type="hidden" name="search" value="1">
                                  <input type="text" placeholder="名称" class="form-control  " style="float:left;width:161px" name="name" value="{{ $_GET['name'] or ''}}">
						...
						<span style="float:right;margin-top:-10px;"><a href="{{url('supplieradd')}}"><button type="button" class="btn bg-olive margin">添加供应商</button></a></span>
