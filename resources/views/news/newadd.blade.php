...
@section('main-content')
    ...
    <div class="box box-info">
        ...
        <!-- form start -->
        @if (isset($data) )
            @section('contentheader_title','编辑健康资讯')
            @section('brade_line')
                @parent
                <li><a href="{{ url('newslist') }}"><i class="fa "></i>健康资讯</a></li>
                <li><a href="{{ url('news/edit',['id'=>$data['id']]) }}"><i class="fa "></i>编辑健康资讯</a></li>
                @stop
                <form class="form-horizontal" action="{{url('news/newsave')}}" method="post"  enctype ="multipart/form-data">
        @else
            @section('contentheader_title','添加健康资讯')
            @section('brade_line')
                @parent
                <li><a href="{{ url('newslist') }}"><i class="fa "></i>健康资讯</a></li>
                <li><a href="{{ url('news/newadd') }}"><i class="fa "></i>添加健康资讯</a></li>
                @stop
                <form class="form-horizontal" action="{{ url('news/store') }}" method="post"  enctype ="multipart/form-data">
        @endif
                <div class="box-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label" >健康资讯标题</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" >健康资讯内容</label>
                        <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="inputEmail3">缩略图&nbsp</label>
                <div class="col-sm-10">
                    <input type="file" name="image"><span style="color:red;font-size:12px;">图片尺寸：长750*宽310</span>
