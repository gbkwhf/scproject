...
<div class="box box-info">
            ...
            <!-- form start -->
             	...
             	@section('contentheader_title','合作申请')
             	<form class="form-horizontal" action="{{ url('hzapply/hzapplysave') }}" method="post"  >
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" >合作详情</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="3" disabled="true" placeholder="">{{ $data->content or '' }}</textarea>
                  </div>
                </div>                                   
                <div class="form-group">
