...
<div class="row">
                  ...
                  <div class="box-tools2 ">
                      <form class="form-horizontal" id ="form_action" action="{{url('agency/membercashlist')}}" method="get">
                          <div style="width: 800px;" class="input-group input-group-sm row">
                              ...
                              <div style="position:absolute;right:100px;margin-top:-12px;"> <button type="button" class="btn bg-olive margin" onclick="getOrderExcel()">导出</button></div>                                                                                                                                                                  
    ...
    <script>
        ...
        function getOrderExcel(){
        	$("#form_action").attr('action',"{{ url('agency/membercashexcel') }}");
        	$("#form_action").attr('method','post');	
        	$("#form_action").submit();
        	$("#form_action").attr('action',"{{ url('agency/membercashlist') }}");
