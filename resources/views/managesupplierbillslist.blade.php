...
@section('contentheader_title','供应商申请提现记录')
...
<div class="row">
          ...
          <div class="box">
               ...
               <br><br>
                  <div class="box-tools2 ">
                      <form class="form-horizontal" id ="form_action" action="{{url('manage/suppliercashlist')}}" method="get">
                          <div style="width: 800px;" class="input-group input-group-sm row">
                             ...
                             <div class="col-lg-3">
                              ...
                              <div style="position:absolute;right:60px;margin-top:-12px;"> <button type="button" class="btn bg-olive margin" onclick="getOrderExcel()">导出</button></div>                                                                                                                                                                                                
                          </div>                                                        
                      </form>
                  </div>
              </div>
              ...
              <table class="table table-hover">
                ...
                @foreach ($data as $bill)    				
	    			<tr>
	                  ...
	                  <td>
	                  		<a href="{{ url('manage/suppliercashedit',['id'=>$bill->id]) }}"><button class="btn bg-orange margin" type="button">审批</button></a>
	                  </td>
	                </tr>                
				@endforeach               
              </tbody></table>
    ...
    <script>
        ...
        function getOrderExcel(){
        	$("#form_action").attr('action',"{{ url('manage/suppliercashexcel') }}");
        	$("#form_action").attr('method','post');	
        	$("#form_action").submit();
        	$("#form_action").attr('action',"{{ url('manage/suppliercashlist') }}");
